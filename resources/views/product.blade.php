                            ...
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide product-single__image-item"><img loading="lazy"
                                            class="h-auto" src="../images/products/product_0.jpg" width="104"
                                            height="104" alt=""></div>
                                    <div class="swiper-slide product-single__image-item"><img loading="lazy"
                                            class="h-auto" src="../images/products/product_0-1.jpg" width="104"
                                            height="104" alt=""></div>
                                    <div class="swiper-slide product-single__image-item"><img loading="lazy"
                                            class="h-auto" src="../images/products/product_0-2.jpg" width="104"
                                            height="104" alt=""></div>
                                    <div class="swiper-slide product-single__image-item"><img loading="lazy"
                                            class="h-auto" src="../images/products/product_0-3.jpg" width="104"
                                            height="104" alt=""></div>
                                </div>
                            </div>
                        </div>
                ...
                "spaceBetween": 30
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide product-card">
                            ...
                            <div class="pc__info position-relative">
                                <p class="pc__category">Dresses</p>
                                <h6 class="pc__title"><a href="/product">Cropped Faux Leather Jacket</a>
                                </h6>
                                <div class="product-card__price d-flex">
                        ...
                        <div class="swiper-slide product-card">
                            ...
                            <div class="pc__info position-relative">
                                <p class="pc__category">Dresses</p>
                                <h6 class="pc__title"><a href="/product">Shirt In Botanical Cheetah
                                        Print</a></h6>
                                <div class="product-card__price d-flex">
                                    <span class="money price">$62</span>
                                </div>
